...
function removeFromFavorite(id) {
  ...
  //找出所要刪除的friend在 favoriteFriendList這個陣列中的index，如果傳入的 id 在收藏清單中不存在則return結束這個函式
  ...
  //把更新後的favoriteFriendList，透過直接更改"favoriteFriend"這個key所對應的value，把更新後的favoriteFriendList的資料存到value裡
